package com.mypack.authentication.config;
...
import com.mypack.authentication.service.UserDetailsServiceImpl;
...
public class SecurityConfig {
  ...
  public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
    System.out.println("filterChain(HttpSecurity http, AuthenticationManager authenticationManager).........");
    return http
...
//            our private endpoints
        ...
        //.authenticationProvider(authenticationManager()) //Uncomment authenticationManager()
...
//        (UsernamePasswordAuthenticationFilter creates a UsernamePasswordAuthenticationToken from a username and password that are submitted in the HttpServletRequest.)
  ...
  public AuthenticationManager authenticationManager(HttpSecurity http) throws Exception {
    System.out.println("authenticationManager(HttpSecurity http).................................");
  ...
  /* You can use below method if you want to set AuthenticationProvider
  @Bean
